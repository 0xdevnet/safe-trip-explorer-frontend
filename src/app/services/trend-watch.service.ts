    ...
    this.http
      ...
      .subscribe({
        ...
        error: (error) => {
          this.notifier.notify(
            'error',
            'There Has Been An Error While Fetching Trending Tokens'
          );
        },
      });
    this.http
      .get(this.url.sponsoredlist_url, {
        headers,
        responseType: 'json',
        observe: 'body',
      })
      .subscribe({
        ...
        error: (error) => {
          this.notifier.notify(
            'error',
            'There Has Been An Error While Fetching Sponsored Tokens'
          );
        },
      });
  }
